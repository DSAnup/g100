			...
			<div class="card-body">
				<div class="row">
                    <div class="col-12">
                        ...
                        <cfoutput>
                            <div class="container">                                  
                                <form id="formTransactionSelect" action="/partialIndex.cfm?area=ProfitAndLoss&action=ProfitAndLossSelectAction" method="post" target="formpost">
                                    <div class="row">
