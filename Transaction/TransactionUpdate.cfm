...
<cfquery datasource="#request.dsnameReader#" name="qExpenseCategorySelect"> 
    SELECT *
                          ...
                          <div class="container">
                            <div class="row"> 
                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="PropertyID">
                                                ...
                                                <cfloop query="qPropertySelect">
                                                    <option value="#qPropertySelect.PropertyID#" <cfif qTransactionSelect.PropertyID eq qPropertySelect.PropertyID>selected</cfif>>#qPropertySelect.PropertyName#</option>
                                                </cfloop>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="ExpenseCategoryID">Expense Type</label>
                                            <select class="form-control" name="ExpenseCategoryID">
                                                <option value="">Choose a Expense Type</option>
                                                <cfloop query="qExpenseCategorySelect">
                                                    <option value="#qExpenseCategorySelect.ExpenseCategoryID#" <cfif qTransactionSelect.ExpenseCategoryID eq qExpenseCategorySelect.ExpenseCategoryID>selected</cfif>>#qExpenseCategorySelect.ExpenseCategoryName#</option>
                                                </cfloop>
                                            </select>
                                        </div>
                                        <div class="form-group">
