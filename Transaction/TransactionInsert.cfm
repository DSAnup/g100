                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="PropertyID">
                                                ...
                                                <cfloop query="qPropertySelect">
                                                    <option value="#qPropertySelect.PropertyID#">#qPropertySelect.PropertyName#</option>
                                                </cfloop>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ExpenseCategoryID">
                                                ...
                                                <cfloop query="qExpenseCategorySelect">
                                                    <option value="#qExpenseCategorySelect.ExpenseCategoryID#">#qExpenseCategorySelect.ExpenseCategoryName#</option>
                                                </cfloop>
                                            </select>
                                        </div>
                                        <div class="form-group">
